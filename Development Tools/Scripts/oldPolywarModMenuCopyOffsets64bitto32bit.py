...
_OffsetsPath = r"C:\Users\zachy\AndroidStudioProjects\Polywar-Mod-Menu\app\src\main\jni\Hacks\old\oldoffsets.h"
...
new = replace32bit(get64bit().replace("#else\n","#endif").replace("#if defined(__aarch64__)","#else"))
