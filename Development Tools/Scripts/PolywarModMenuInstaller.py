...
class Logging:
    ...
    @staticmethod
    def printmessage_colorized(message: str, messagetype: str, special=False):
        """
...
def copydirectory(oldpath, newpath, cancelifoverwrite=False, loggingimportance=False):
    ...
    try:
        ...
        logging.warning(f"OSError exception occurred copying directory {oldpath} to {newpath}: {exception}")
    except IOError as exception:
        #raise IOError(exception)
        logging.warning(f"IOError exception occurred copying directory {oldpath} to {newpath}: {exception}")
...
modmenu = ModMenuInstall(r"C:\Users\zachy\OneDrive\Documents\APK Easy Tool\1-Decompiled APKs\POLYWAR V1.22",
               r"C:\Users\zachy\OneDrive\Documents\APK Easy Tool\1-Decompiled APKs\Modded POLYWAR V1.22",
